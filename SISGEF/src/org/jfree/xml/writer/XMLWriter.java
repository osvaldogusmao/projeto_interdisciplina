 ...
 *
 * $Id: XMLWriter.java,v 1.2 2005/03/04 10:01:44 taqua Exp $
 *
...
public class XMLWriter extends XMLWriterSupport {
    ...
    /**
     * Creates a new XML writer for the specified character stream.  By default, four spaces are
     ...
     *
     * @param writer       the character stream.
     * @param indentString the string used for indentation (should contain white space, for
     *                     example four spaces).
     */
     ...
     */
    public void writeTag(final String name, final boolean close) throws IOException {
        if (close) {
     ...
     * @throws java.io.IOException if there is an I/O problem.
     */
    public void writeTag(final String name, final String attributeName, final String attributeValue,
     ...
     * @throws java.io.IOException if there is an I/O problem.
     */
    public void writeTag(final String name, final AttributeList attributes, final boolean close) throws IOException {
     ...
     */
    public void writeTag(final String name, final Properties attributes, final boolean close) throws IOException {
        writeTag(this.writer, name, attributes, close);
    }
