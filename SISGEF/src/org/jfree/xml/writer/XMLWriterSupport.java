 ...
 *
 * $Id: XMLWriterSupport.java,v 1.3 2005/03/04 10:01:45 taqua Exp $
 *
 * Changes
 * -------
...
public class XMLWriterSupport {
    ...
    /** A flag indicating whether to force a linebreak before printing the next tag. */
    private boolean newLineOk;

    /**
     * Default Constructor. The created XMLWriterSupport will not have no safe tags
     * and starts with an indention level of 0.  
     */
     ...
     * @throws java.io.IOException if there is an I/O problem.
     */
    public void writeCloseTag(final Writer w, final String tag) throws IOException {
     ...
     * @throws java.io.IOException if there is an I/O problem.
     */
    public void writeTag(final Writer w, final String name, final String attributeName, final String attributeValue,
     ...
     */
    public void writeTag(final Writer w, final String name, final Properties attributes, final boolean close)
        throws IOException {
     ...
     * @throws java.io.IOException if there is an I/O problem.
     */
    public void writeTag(final Writer w, final String name, final AttributeList attributes, final boolean close)
        throws IOException {
     ...
     */
    public void indent(final Writer writer, final int increase) throws IOException {
