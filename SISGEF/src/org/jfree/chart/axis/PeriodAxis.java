 ...
 * Contributor(s):   -;
 *
 * $Id: PeriodAxis.java,v 1.16 2005/05/19 13:58:11 mungady Exp $
 *
 * Changes
 * -------
...
public class PeriodAxis extends ValueAxis 
    ...
    public AxisSpace reserveSpace(Graphics2D g2, Plot plot, 
        ...
        if (this.minorTickMarksVisible) {
            tickMarkSpace = Math.max(
                tickMarkSpace, this.minorTickMarkOutsideLength
            );
        }
    ...
    public AxisState draw(Graphics2D g2, 
        ...
        // returned)...
        axisState = drawLabel(
            getLabel(), g2, plotArea, dataArea, edge, axisState
        );
        return axisState;
