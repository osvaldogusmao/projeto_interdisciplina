 ...
 * Contributor(s):   -;
 *
 * $Id: XYBoxAnnotationTests.java,v 1.2 2005/02/28 16:10:46 mungady Exp $
 *
 * Changes
 * -------
...
public class XYBoxAnnotationTests extends TestCase {
    ...
    public void testEquals() {
        ...
        // outlinePaint
        a1 = new XYBoxAnnotation(
            1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f), Color.green, Color.blue
        );
        assertFalse(a1.equals(a2));
        a2 = new XYBoxAnnotation(
            1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f), Color.green, Color.blue
        ...
        // fillPaint
        a1 = new XYBoxAnnotation(
            1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f), Color.green, Color.yellow
        );
        assertFalse(a1.equals(a2));
        a2 = new XYBoxAnnotation(
            1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f), Color.green, Color.yellow
