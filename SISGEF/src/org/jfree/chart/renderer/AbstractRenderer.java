 ...
 *
 * $Id: AbstractRenderer.java,v 1.22 2005/06/01 09:35:54 mungady Exp $
 *
 * Changes:
 * --------
    ...
    protected Point2D calculateLabelAnchorPoint(ItemLabelAnchor anchor,
        ...
        if (anchor == ItemLabelAnchor.CENTER) {
            ...
            result = new Point2D.Double(
                x + OPP * this.itemLabelAnchorOffset, 
                y - ADJ * this.itemLabelAnchorOffset
            );
        }
        else if (anchor == ItemLabelAnchor.INSIDE2) {
            result = new Point2D.Double(
                x + ADJ * this.itemLabelAnchorOffset, 
            ...
            result = new Point2D.Double(
                x + 2.0 * this.itemLabelAnchorOffset, y
            );
        }
            ...
            result = new Point2D.Double(
                x, y + 2.0 * this.itemLabelAnchorOffset
            );
        }
