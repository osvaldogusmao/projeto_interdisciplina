 ...
 *
 * $Id: BarRenderer.java,v 1.13 2005/06/02 08:38:36 mungady Exp $
 *
 * Changes
 * -------
...
public class BarRenderer extends AbstractCategoryItemRenderer 
    ...
    protected double calculateBarW0(CategoryPlot plot, 
        ...
        if (seriesCount > 1) {
            ...
            double seriesW = calculateSeriesWidth(
                space, domainAxis, categoryCount, seriesCount
            );
    ...
    public void drawItem(Graphics2D g2,
        ...
        double barLength = Math.max(
            Math.abs(transL1 - transL0), getMinimumBarLength()
        );
