 ...
 *                   Nicolas Brodu;
 *
 * $Id: Range.java,v 1.6 2005/05/19 10:34:07 mungady Exp $
 *
...
public strictfp class Range implements Serializable {
    ...
    public static Range combine(Range range1, Range range2) {
        if (range1 == null) {
            ...
            if (range2 == null) {
                ...
                double l = Math.min(
                    range1.getLowerBound(), range2.getLowerBound()
                );
                double u = Math.max(
                    range1.getUpperBound(), range2.getUpperBound()
                );
    ...
    public static Range expand(Range range, 
        ...
        return new Range(
            range.getLowerBound() - lower, range.getUpperBound() + upper
        );
    }
    ...
    public static Range shift(Range base, double delta, 
        ...
        if (allowZeroCrossing) {
            return new Range(
                base.getLowerBound() + delta, base.getUpperBound() + delta
            );   
        }
        else {
            return new Range(
