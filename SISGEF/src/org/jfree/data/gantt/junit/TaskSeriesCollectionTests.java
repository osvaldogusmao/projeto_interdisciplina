 ...
 * Contributor(s):   -;
 *
 * $Id: TaskSeriesCollectionTests.java,v 1.5 2005/05/20 08:20:05 mungady Exp $
 *
 * Changes
 * -------
...
public class TaskSeriesCollectionTests extends TestCase {
    ...
    private TaskSeriesCollection createCollection3() {
        ...
        Task taskA1 = new Task(
            "Task 1", new SimpleTimePeriod(new Date(100), new Date(200))
        );
        taskA1.setPercentComplete(0.1);
        taskA1.addSubtask(sub1);
        Task taskA2 = new Task(
            "Task 2", new SimpleTimePeriod(new Date(220), new Date(350))
        );
        ...
        Task taskB2 = new Task(
            "Task 2", new SimpleTimePeriod(new Date(2220), new Date(3350))
        );
    ...
    public void test697153() {
        ...
        s2.add(
            new Task("Task 4", new SimpleTimePeriod(new Date(), new Date()))
        );
