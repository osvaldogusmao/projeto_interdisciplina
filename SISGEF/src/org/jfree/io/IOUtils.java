 ...
 *
 * $Id: IOUtils.java,v 1.4 2004/11/05 17:19:21 taqua Exp $
 *
 * Changes
 * -------
...
public class IOUtils {
     ...
     * @throws IOException if a IOError occurs.
     */
    public void copyStreams(final InputStream in, final OutputStream out, final int buffersize)
        throws IOException {
     ...
     * @throws IOException if a IOError occurs.
     */
    public void copyWriter(final Reader in, final Writer out, final int buffersize)
        throws IOException {
        // create a 4kbyte buffer to read the file
