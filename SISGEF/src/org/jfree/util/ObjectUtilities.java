 ...
 * Contributor(s):   -;
 *
 * $Id: ObjectUtilities.java,v 1.8 2005/06/01 14:12:30 taqua Exp $
 *
 * Changes
 * -------
...
public final class ObjectUtilities {
    ...
    public static Object clone(final Object object) throws CloneNotSupportedException {
        ...
        if (object instanceof PublicCloneable) {
            ...
            try {
                final Method method = object.getClass().getMethod("clone", null);
     ...
     * @return A new collection containing clones of all the items in the specified
     *         collection.
     * @throws CloneNotSupportedException if any of the items in the collection cannot
     *                                    be cloned.
     */
     ...
     */
    public synchronized static void setClassLoader(final ClassLoader classLoader) {
     ...
     * @throws SecurityException if the SecurityManager does not allow to grab the
     *                           context classloader.
     */
     ...
     * it to the classes package name. If the name is already a global name
     * (the name starts with a "/"), then the name is returned unchanged.
     *
