 ...
 * Contributor(s):   -;
 *
 * $Id: PaintUtilities.java,v 1.6 2005/06/01 14:12:30 taqua Exp $
 *
 * Changes
 * -------
...
public class PaintUtilities {
    ...
    public static boolean equal(final Paint p1, final Paint p2) {
        ...
        if (p1 instanceof GradientPaint && p2 instanceof GradientPaint) {
            ...
            result = ObjectUtilities.equal(gp1.getColor1(), gp2.getColor1()) 
                && ObjectUtilities.equal(gp1.getColor2(), gp2.getColor2())
                && ObjectUtilities.equal(gp1.getPoint1(), gp2.getPoint1())    
                && ObjectUtilities.equal(gp1.getPoint2(), gp2.getPoint2())
