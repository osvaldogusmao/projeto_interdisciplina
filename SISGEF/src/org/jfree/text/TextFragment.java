 ...
 * Contributor(s):   -;
 *
 * $Id: TextFragment.java,v 1.10 2005/06/01 14:12:29 taqua Exp $
 *
 * Changes
 * -------
...
public class TextFragment implements Serializable {
    ...
    protected static final LogContext logger 
        = Log.createContext(TextFragment.class);
    ...
    public void draw(final Graphics2D g2, final float anchorX, 
        ...
        TextUtilities.drawRotatedString(
            this.text, g2, anchorX, anchorY, anchor, angle, rotateX, rotateY
        );
